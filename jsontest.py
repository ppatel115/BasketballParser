...
for x in matchupsList:
    ...
    print("Florida Stats: ")
    print(x.florida2PFGM)
    print(x.florida2PFGA)
    print(x.floridaPFGM)
    print(x.floridaPFGA)
    print(x.florida3PFGM)
    print(x.florida3PFGA)
    print(x.floridaFTM)
    print(x.floridaFTA)
    print(x.floridaTO)
    print(x.floridaORB)
    ...
    print(x.opponent2PFGM)
    print(x.opponent2PFGA)
    print(x.opponentPFGM)
    print(x.opponentPFGA)
    print(x.opponent3PFGM)
    print(x.opponent3PFGA)
    print(x.opponentFTM)
    print(x.opponentFTA)
    print(x.opponentTO)
    print(x.opponentORB)
